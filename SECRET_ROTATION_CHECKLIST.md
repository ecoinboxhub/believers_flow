...
| 5 | **PostgreSQL Password** | `avnadmin:AVNS_TbK8CVxa0tulXEu5KaN` | Aiven Console → PostgreSQL → Users → Reset password → Update `DATABASE_URL` | App will fail to connect to DB |
