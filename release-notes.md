...
### This release
- Removed Young's Literal Translation (YLT): the upstream bible-api.com source only serves the New Testament for YLT, so Old Testament chapters returned 404; the translation is no longer listed or selectable.
- Church Devotionals now include only churches with full, readable content: Dunamis, RCCG Open Heaven, MFM, Deeper Life, Rhapsody of Realities, FCS, Food for the Day, Daily Manna, Winners Chapel, and CAC. Churches with no viewable content were removed.
- Tapping a devotional's scripture reference now opens that passage in the app's Bible reader.
