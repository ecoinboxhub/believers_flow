...
const LEGAL_DOCS = [
  {
    ...
    content: `**Effective Date: July 7, 2026 | Version: 1.1.0**

This policy explains what information BelieversFlow collects, how we use and protect it, and the choices you have over your own data. We have written it in plain, natural language so you always know what is happening with your information.

## 1. Information We Collect

### 1.1 Account Information (Optional)
If you create an account, we collect your email address, your name, and a securely hashed version of your password. This information is stored in our database and is used solely for account management and authentication. You are never required to create an account — every core feature of BelieversFlow works without one.

### 1.2 User-Generated Content
Tasks, prayer logs, diary entries, Bible highlights, and any other personal data you create in the app are stored locally on your device by default. This data never leaves your device unless you explicitly choose to enable cloud sync, and we have no access to your locally stored data.
...
### 1.4 AI Feature Data
When you use AI-powered features such as verse explanation, commentary, or the Faith Assistant, your queries are processed by third-party AI services. These queries are never used to train AI models. We keep query logs for up to 30 days for quality improvement, after which they are permanently deleted.

### 1.5 Device Information
We collect basic device information such as app version and device type. This information is used solely for improving app performance and is never shared with third parties.

## 2. How We Use Your Information

We use the information we collect to provide and improve the BelieversFlow experience, personalize your content, process any subscriptions you purchase, send important service-related communications, and maintain the security of our platform.
...
- All data transmitted between your device and our servers is encrypted with TLS technology.
- Our database employs encryption at rest.
...
We retain your account data until you request deletion. AI interaction data is automatically deleted after 30 days, and security logs are retained for 12 months for protection purposes. If you delete your account, all associated data is permanently removed from our systems.
...
These Terms of Service form the legal agreement between you and BelieversFlow. They explain what you can expect from us, and what we ask of you, in clear natural language.
...
BelieversFlow is a Christian lifestyle application that brings together task management with faith-centered organization, prayer tracking and spiritual growth tools, a Bible reader with multiple translations, AI-powered faith guidance and commentary, a hymn library with over one thousand hymns, daily devotionals, and optional cloud synchronization across your devices.

## 3. User Accounts

You may use BelieversFlow without creating an account, and all core features are available in local-only mode. Creating an account is optional and enables additional features such as cloud sync and AI assistance. You are responsible for maintaining the security of your account credentials, and only one account per person is permitted.

## 4. Acceptable Use

You agree to use BelieversFlow for its intended purpose as a Christian spiritual growth tool, and to treat all users with respect and kindness. You agree not to use the service for any illegal activities, attempt to disrupt or compromise the service, impersonate others, or share content that is harmful, hateful, or inappropriate for a Christian audience.

## 5. Intellectual Property

BelieversFlow and its original content, features, and functionality are owned by us and protected by copyright, trademark, and other intellectual property laws. You retain full ownership of any content you create within the app. Bible scripture content is in the public domain, while hymn lyrics may be subject to copyright held by their respective authors or publishers.

## 6. AI Features

BelieversFlow includes AI-powered features that provide faith-related guidance, verse explanations, and commentary, powered by third-party AI models. AI-generated responses are provided for informational and inspirational purposes only and are not a substitute for professional spiritual counsel, medical advice, legal advice, or any other professional guidance. We do not guarantee the accuracy of AI-generated content.

## 7. Subscriptions

The core features of BelieversFlow are free to use. Future premium features may require a paid subscription. Subscription terms, pricing, and payment processing details will be clearly communicated before any purchase is required, and you may cancel your subscription at any time.

## 8. Disclaimer of Warranties

BelieversFlow is provided on an as-is and as-available basis. We make no warranties, expressed or implied, regarding the reliability, availability, or suitability of the service for any particular purpose, and we do not warrant that the service will be uninterrupted, error-free, or completely secure.
...
We reserve the right to suspend or terminate your account if you violate these Terms of Service or engage in conduct that is harmful to other users or the platform, or for any other reason at our sole discretion with reasonable notice.
...
These Terms of Use set out the rules for using BelieversFlow and its community features. They are rooted in Christian values of love, respect, and kindness, and are written in clear natural language.
...
BelieversFlow is a faith-based platform. We ask all users to treat one another with love, respect, and kindness as taught in Scripture. Avoid speech or behavior that is hateful, discriminatory, or harassing, and share content that is appropriate for a Christian audience and focused on unity in Christ.
...
- Any attempt to disrupt or compromise the integrity of the service.

## 3. Content Guidelines

### 3.1 User Content
You own all content you create within BelieversFlow. Your content should be appropriate for a Christian audience and should not contain the private information of others without their consent. Please respect the intellectual property rights of others when sharing content.

### 3.2 AI-Generated Content
AI-powered features in BelieversFlow generate responses for informational and inspirational purposes. These responses may occasionally contain errors or inaccuracies, and AI is not a substitute for professional spiritual counsel or any form of professional advice. Please do not rely solely on AI-generated content for critical decisions.
...
These Community Guidelines describe how we expect you to behave in the BelieversFlow community, and are written in clear natural language.
...
- Support and uplift other users through kind and thoughtful interactions.
- Share prayer requests and testimonies that build community.
- Ask questions and seek spiritual growth together.
- Celebrate blessings and answered prayers.
- Offer scripture-based encouragement to those who are struggling.

## 3. Prohibited Behavior

The following behaviors undermine our community and are not permitted:

- Hate speech, discrimination, or prejudice of any kind.
- Harassment, bullying, or intimidation.
- Spam, unsolicited advertising, or commercial solicitation.
- Spreading misinformation or false teachings.
- Impersonating other users or leaders.
- Sharing private or personal information of others without consent.
- Any content that promotes harm, violence, or illegal activity.

## 4. Content Standards

All content shared within BelieversFlow should be appropriate for a Christian audience. Use language that is respectful, wholesome, and edifying. Ensure that shared content is truthful and accurate, and avoid content that is divisive, provocative, or designed to cause conflict.
...
We take community standards seriously. When violations occur, we may:

- Issue a written warning for minor violations.
- Remove content that violates these guidelines.
- Restrict access to certain features for repeated violations.
- Suspend accounts temporarily for serious violations.
- Terminate accounts for severe or persistent violations.

We aim to restore rather than punish, but we will protect the integrity of our community.
...
This disclosure provides a complete account of the data BelieversFlow collects and why, written in clear natural language.
...
Passwords are encrypted using industry-standard hashing. All data in transit is protected with TLS encryption. Our database uses encryption at rest, and we conduct regular security reviews.
...
This policy explains how BelieversFlow protects your data and maintains the security of the platform, written in clear natural language.
...
All passwords are hashed using **bcrypt**, an industry-standard hashing algorithm. We never store passwords in plain text, and passwords must meet minimum complexity requirements.

### 2.2 JWT Tokens
We use JSON Web Tokens (JWT) for session management. Access tokens expire after 15 minutes and require refresh, refresh tokens expire after 30 days, and compromised tokens can be immediately revoked through our token blocklist system.
...
This policy explains how BelieversFlow uses cookies and similar technologies, written in clear natural language.
...
- **Security cookies** may be retained longer for fraud prevention.
...
This policy explains how BelieversFlow moderates content to maintain a safe community, written in clear natural language.
...
- Hate speech or discrimination based on race, ethnicity, gender, sexual orientation, religion, or disability.
- Harassment, bullying, or intimidation.
- Spam, advertising, or commercial solicitation.
- Misinformation or false teachings.
...
When content violates our policies, we may:

- Remove the violating content.
- Issue a warning to the user.
- Temporarily restrict access to certain features.
- Suspend the user's account.
- Permanently terminate the account for severe violations.
...
AI-generated content is provided for informational and inspirational purposes only. It may occasionally contain errors or inaccuracies, and AI is not a substitute for professional spiritual counsel or any form of professional advice.

## 7. Transparency

We provide clear guidelines about what content is acceptable. We notify users when their content is moderated and provide reasons for the action, and we maintain records of moderation actions for accountability.
...
This Acceptable Use Policy outlines the rules and guidelines for using BelieversFlow, written in clear natural language.
...
BelieversFlow is designed for:

- Personal spiritual growth and devotional activities.
- Task management with faith-centered organization.
- Prayer tracking and spiritual discipline.
- Bible study and scripture exploration.
- Hymn worship and music appreciation.
- Community building among believers.

## 3. Prohibited Uses

You agree not to use BelieversFlow for:

- Any illegal activities or purposes.
- Harassment, bullying, or intimidation of other users.
- Spreading misinformation or false teachings.
- Distributing spam or unsolicited advertising.
- Attempting to gain unauthorized access to our systems.
- Interfering with or disrupting the service.
- Impersonating others or misrepresenting your identity.
- Sharing content that is harmful, hateful, or inappropriate.
...
- Ensuring your use complies with this policy.
...
This disclosure lists the third-party services BelieversFlow integrates with and how they handle your data, written in clear natural language.
...
We do not sell your data to any third party. We share data only as necessary to provide the services described above, and all third-party providers are bound by data protection agreements.

## 9. Your Choices

You can use BelieversFlow without creating an account, which limits data shared with third parties. AI features require sending queries to AI providers, and you can choose not to use AI features if you prefer.
...
This policy explains how long BelieversFlow retains different types of data and when data is deleted, written in clear natural language.
...
### 2.1 Active Accounts
While your account is active, we retain your email address, name, and hashed password, your preferences and settings, and any cloud-synced content.

### 2.2 Account Deletion
When you delete your account:

- All personal information is permanently deleted within 30 days.
- Cloud-synced content is permanently deleted within 7 days.
...
### 4.1 Query Logs
AI queries are retained for up to 30 days for quality improvement purposes, after which they are permanently deleted. Queries are not used for AI training.
...
This document outlines BelieversFlow's plan for responding to security incidents and data breaches to protect our users and minimize impact, written in clear natural language.
...
Immediately assess the severity and scope of the incident, preserve evidence for investigation, and document all findings and actions taken.

### 4.2 Containment
Isolate affected systems to prevent further damage, implement temporary fixes if necessary, and maintain service availability for unaffected users.

### 4.3 Eradication
Remove the root cause of the incident, apply security patches and updates, and strengthen defenses to prevent recurrence.

### 4.4 Recovery
Restore systems from clean backups if necessary, verify system integrity before returning to production, and monitor for signs of continued compromise.

## 5. Notification

### 5.1 User Notification
For incidents involving user data, we will notify affected users within 72 hours, provide clear information about what data was affected, explain steps users should take to protect themselves, and offer support and resources.

### 5.2 Regulatory Notification
We comply with all applicable data protection regulations, including GDPR, CCPA, and other relevant laws.

### 5.3 Law Enforcement
We report criminal activity to appropriate law enforcement agencies.
...
### 7.1 Documentation
Document all aspects of the incident for future reference and create a detailed incident report.

### 7.2 Lessons Learned
Conduct a post-incident review to identify improvements, update security policies and procedures as needed, and implement additional safeguards to prevent similar incidents.

### 7.3 Follow-Up
Monitor for signs of continued compromise, verify that all remediation steps are complete, and provide a final update to affected users.
...
This document explains how BelieversFlow complies with applicable data protection regulations, written in clear natural language.
...
BelieversFlow is not directed to children under 13, and we do not knowingly collect personal information from children under 13.
...
### 5.2 LGPD (Brazil)
We comply with the Lei Geral de Proteção de Dados where applicable.

## 6. Data Protection Measures

### 6.1 Technical Measures
We implement encryption of data in transit and at rest, access controls and authentication, regular security audits and penetration testing, and vulnerability management.

### 6.2 Organizational Measures
We provide employee training on data protection, conduct data protection impact assessments, review policies regularly, and follow incident response procedures.
...
This checklist summarizes BelieversFlow's compliance commitments and certifications, written in clear natural language.
...
- **Status**: Implemented.
- **Details**: Access, rectification, erasure, portability, and objection rights available through the app and email.
...
- **6.1 Terms of Service**: Published and accessible. Last Updated: July 7, 2026.
- **6.2 Terms of Use**: Published and accessible. Last Updated: July 7, 2026.
- **6.3 Cookie Policy**: Published and accessible. Last Updated: July 7, 2026.
- **6.4 Acceptable Use Policy**: Published and accessible. Last Updated: July 7, 2026.
...
### 8.2 Data Export
- **Status**: Implemented.
- **Details**: Users can export their data through the backup/restore feature.
...
- **Status**: Planned.
- **Details**: Annual penetration testing by a third party is planned for future implementation.
...
function renderInlineLegal(text) {
...
function renderLegalDoc(content) {
  ...
  const flushList = () => {
    if (list) {
      nodes.push(
        <ul className="legal-rich-list" key={`ul-${nodes.length}`}>
          {list.map((item, i) => <li key={i}>{renderInlineLegal(item)}</li>)}
        </ul>
      )
      list = null
    }
  ...
  for (const raw of lines) {
    ...
    if (line.startsWith('### ')) {
      flushList()
      nodes.push(<h4 className="legal-rich-h4" key={`h4-${nodes.length}`}>{renderInlineLegal(line.slice(4))}</h4>)
    } else if (line.startsWith('## ')) {
      flushList()
      nodes.push(<h3 className="legal-rich-h3" key={`h3-${nodes.length}`}>{renderInlineLegal(line.slice(3))}</h3>)
    } else if (line.startsWith('- ')) {
      list = list || []
      list.push(line.slice(2))
    } else {
      flushList()
      nodes.push(<p className="legal-rich-p" key={`p-${nodes.length}`}>{renderInlineLegal(line)}</p>)
    }
  }
  flushList()
    ...
    return (
      <div className="legal-overlay" onClick={handleBackdropClose}>
        <div className="legal-panel legal-doc-view" onClick={e => e.stopPropagation()}>
          ...
          <div className="legal-doc-meta-line">
